...
public class Calib3d {
    ...
    //
    // C++:  bool findCheckerboardCorners(Mat image, Size patternSize, vector_Point2f& corners, int flags = CALIB_CB_ADAPTIVE_THRESH + CALIB_CB_NORMALIZE_IMAGE)
    //

    //javadoc: findCheckerboardCorners(image, patternSize, corners, flags)
    public static boolean findCheckerboardCorners(Mat image, Size patternSize, MatOfPoint2f corners, int flags)
    {
    ...
    //javadoc: findCheckerboardCorners(image, patternSize, corners)
    public static boolean findCheckerboardCorners(Mat image, Size patternSize, MatOfPoint2f corners)
    {
        Mat corners_mat = corners;
